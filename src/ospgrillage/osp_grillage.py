...
class OspGrillage:
    ...
    def __init__(
        ...
        * non_cont_spacing_x: (float) sets spacing or length of stitch elements.
        ...
        self.fix_val_pin = [1, 1, 1, 0, 0, 1]  # pinned
    ...
    def create_duplicate_nodes(self, node_tags: List[int], distances: List[float]) -> List[int]:
        """
        ...
        Returns:
            List[int]: List of created duplicate node tags
        """
        # Initialize list to store duplicate node tags
        duplicate_node_tags = []
        ...
        for distance in distances:
            ...
            for node_tag in node_tags:
                ...
                # Add to duplicate node tags list
                duplicate_node_tags.append(current_node_tag)
                current_node_tag += 1
    ...
    * manages multiple load case's ops.load() commands, applying the specified load factors to the load cases for load combinations
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.numberer_command = "ops.numberer('RCM')\n"  # default numberer is Plain
        ...
        self.intergrator_command = "ops.integrator('LoadControl', 0.5)\n"
